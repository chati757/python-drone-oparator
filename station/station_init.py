...
CONSOLE_INNER_INFO_COL=3
CONSOLE_INNER_INFO_ROW=2
CONSOLE_INNER_CMD_COL=3
CONSOLE_INNER_CMD_ROW=(CONSOLE_PANEL_SIZE_HIGH-2)#27
CONSOLE_COUNT_LINE=CONSOLE_INNER_INFO_ROW
